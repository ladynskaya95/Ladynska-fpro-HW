...
const myOrdersButton = document.querySelector(".myOrdersButton");
 ...
 const orderFormElement = document.getElementById("order");
  ...
  productInfoContainer.appendChild(buyButton);
   ...
   orderFormElement.addEventListener("submit", function(event) {
        ...
        if (name && city && delivery && payment && quantity) {
            ...
            document.getElementById("customer-city").textContent = city;
            document.getElementById("customer-delivery").textContent = delivery;
            document.getElementById("customer-payment").textContent = payment;
            document.getElementById("order-quantity").textContent = quantity;
            document.getElementById("order-comment").textContent = comment;
